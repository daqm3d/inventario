...
<!--logo--><link rel="shortcut icon" href="C:\wamp\www\Proyecto\logo.jpg" />
	  ...
	  <td><table width="45%" border="10" cellspacing="10" cellpadding="" align="center">
		   ...
		   <td><H1><i><font color=#2EFE2E>EDITAR DATOS CLIENTES</font></i></H1></td>
		   </tr></table></td><br>
		   <center>
<!--insertar--><form  action="editar.php" method="post" name="form" >
<table border="4" cellspacing="7" cellpadding="1" width="45%" >
<tr>
<td><center><b><font color=#2EFE2E>Cedula</font></b></td></center>
<td><center><input type="text" name="CI_Cliente" size="20"/></center></td>
...
<!--voton--><td colspan"1"><center><input type="submit"  value="Modificar"/></td></center> </form>
</tr>
   </table>
   </center>
   <!--menu-->
