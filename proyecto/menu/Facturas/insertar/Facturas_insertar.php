...
<!--logo--><link rel="shortcut icon" href="C:\wamp\www\Proyecto\logo.jpg" />
	  ...
	  <td><table width="45%" border="10" cellspacing="10" cellpadding="" align="center">
		   ...
		   <td><H1><i><font color=#FFF8DC>NUEVAS FACTURAS</font></i></H1></td>
		   </tr></table></td><br>
		   <center><!--insertar--><form name="Registro" action="insertar.php" method="post" ">
...
<!--voton--><td colspan"1"><center><input type="submit" name="btnRegistrar" value="Guardar"  /></td></center>
</tr>
   </table>
   </center>
