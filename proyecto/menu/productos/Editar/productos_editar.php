...
<!--logo--><link rel="shortcut icon" href="C:\wamp\www\Proyecto\logo.jpg" />
	  ...
	  <td><table width="45%" border="10" cellspacing="10" cellpadding="" align="center">
		   ...
		   <td><H1><i><font color=#FFF8DC>EDITAR DATOS PRODUCTOS</font></i></H1></td>
		   </tr></table></td><br>
		   <center>
...
<!--voton--><td colspan"1"><center><input type="submit" name="btnRegistrar" value="Modificar"  /></td></center></form>
</tr>
   </table>
   </center>
   <!--menu-->
